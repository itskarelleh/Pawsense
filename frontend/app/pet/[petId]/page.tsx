...
import { getAllEventsForPet, getPetById, getPetDetails, getPets } from '@/server_actions';
...
export default async function PetPage({ params }: { params: { petId: string } }) {
    ...
    const details : Details = { bio: 'Pinot is a big baby. He’s very vocal and will let you know how he feels. He looovvvees food a lot and always tries to steal extra cat food. He even tries to steal mine. He loves a lot of affection.', adoptionDate: '02/26/2022', age: 8, size: 'large', weight: 14.2, birthDate: '02/26' };
